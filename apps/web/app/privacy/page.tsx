export default function PrivacyPolicyPage() {
    return (
      <div className="container mx-auto py-8 px-4">
        ...
        <p className="mb-4">
          At OpenScoreboard, we are committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your information when you use our services.
        </p>
        ...
        <ul className="list-disc list-inside mb-4">
          <li>Personal information, such as your name, email address, and website (if provided).</li>
          <li>Account information, such as your username and scores submitted to scoreboards.</li>
        ...
        <ul className="list-disc list-inside mb-4">
          ...
          <li>To protect the rights, property, or safety of OpenScoreboard, its users, or others.</li>
        ...
        <p className="mb-4">
          Email: <a href="mailto:support@koyu.space" className="text-blue-500">support@koyu.space</a>
        </p>
